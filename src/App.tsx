      ...
      >
        <div className="neu-card p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="flex gap-3 justify-center">
            ...
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-foreground/70">
            ...
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" style={{ color: '#1DA1F2' }}>
